...
import petbook.service.AuthService;
...
public class AuthServiceImpl implements AuthService, UserDetailsService {
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		String[] roles = participant.isAdmin() ? new String[] { "ADMIN", "USER" } : new String[] { "USER" };

		return User.builder().username(participant.getEmail()).password(participant.getPassword()).roles(roles).build();
	}
